            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="text-gray-300 space-y-3">
                  ...
                  <div className="bg-card-bg border border-card rounded-lg p-4 mt-3">
                    ...
                    <p className="mt-2">Telefon: <a href={COMPANY_INFO.contact.phoneLink} className="text-primary-400 hover:text-primary-300">{COMPANY_INFO.contact.phone}</a></p>
                    <p>E-Mail: <a href={COMPANY_INFO.contact.emailLink} className="text-primary-400 hover:text-primary-300">{COMPANY_INFO.contact.email}</a></p>
                  </div>
                  <p className="mt-4">
