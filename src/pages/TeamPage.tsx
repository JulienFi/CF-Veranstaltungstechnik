        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed">
              Lernen Sie das Team kennen, das Ihre Veranstaltung in Berlin und Brandenburg technisch absichert. Wir planen praezise, arbeiten verlaesslich und entlasten Sie im Ablauf.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-400">Unser Anspruch fuer Ihr Event</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Ueber 10 Jahre kombinierte Erfahrung in allen Bereichen der Veranstaltungstechnik.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3">Kreativitaet</h3>
                <p className="text-gray-400 leading-relaxed">
                  Innovative Loesungen und kreative Konzepte fuer unvergessliche Events.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3">Zuverlaessigkeit</h3>
                <p className="text-gray-400 leading-relaxed">
                  Puenktlich, professionell und mit hoechstem Qualitaetsanspruch.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Wir beraten Sie persoenlich und erstellen ein passendes Technik- und Servicekonzept fuer Ihr Event.
            </p>
