            ...
            {team.map((member) => (
              <div key={member.id} className="glass-panel card interactive-card group overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  {member.bio ? <p className="mb-4 text-sm leading-relaxed text-gray-300">{member.bio}</p> : null}
        ...
        <div className="content-container">
          <div className="mx-auto max-w-4xl">
            <div className="section-head mb-10">
              ...
              <p className="section-copy">Ruhige Abläufe, klare Zuständigkeiten, verlässliche Umsetzung.</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
              <div className="glass-panel--soft card-inner p-5 text-center">
                ...
                <h3 className="mb-3 text-xl font-bold">Erfahrung</h3>
                <p className="leading-relaxed text-gray-300">
                  Seit 2014 im Einsatz mit rund 90 Events pro Jahr in unterschiedlichen Formaten.
                </p>
              </div>
              ...
              <div className="glass-panel--soft card-inner p-5 text-center">
                ...
                <h3 className="mb-3 text-xl font-bold">Präzision</h3>
                <p className="leading-relaxed text-gray-300">
                  Passende Lösungen statt Standardpakete – abgestimmt auf Ort, Ablauf und Ziel.
                </p>
              </div>
              ...
              <div className="glass-panel--soft card-inner p-5 text-center">
                ...
                <h3 className="mb-3 text-xl font-bold">Timing</h3>
                <p className="leading-relaxed text-gray-300">
                  Aufbau nach festen Timings – pünktlich zum Einlass und sauber im Ablauf.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="content-container">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="section-copy mb-8 text-gray-200">
              Wir beraten persönlich und erstellen ein passendes Technik- und Servicekonzept für Miete oder Full-Service.
            </p>
